...
def _ensure_repo_import_path() -> None:
    # scorer_worker.py lives at qwen3.5-35b-a3b/qwen35_moe_rl/scorer_worker.py
    # Add qwen3.5-35b-a3b/ to sys.path so `import qwen35_moe_rl.*` works without install.
...
from qwen35_moe_rl.config import MetricXConfig, XCometConfig  # noqa: E402
from qwen35_moe_rl.rewards import MetricXQEScorer, XCometXLScorer  # noqa: E402
from qwen35_moe_rl.types import SampleForScoring  # noqa: E402
